...
# SoftPro Integration (Client Initiated Workflow)

This README file describes several API endpoints as part of the Client Initiated Workflow for integrating with SoftPro, a real estate and title insurance software company. The document provides detailed information on the required fields for each endpoint, including validation rules.
...
| System                           | System integration type                                                          | enum      | Required, must be "Softpro"                                                |
